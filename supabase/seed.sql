...
values
  ('00000000-0000-4000-8000-000000008101', 'authenticated', 'authenticated', 'demo.admin@example.test', crypt('DemoPass!2026', gen_salt('bf')), now(), '{"first_name":"Demo","last_name":"Administrator","full_name":"Demo Administrator"}'::jsonb, now(), now()),
  ('00000000-0000-4000-8000-000000008102', 'authenticated', 'authenticated', 'demo.hr@example.test', crypt('DemoPass!2026', gen_salt('bf')), now(), '{"first_name":"Demo","last_name":"Human Resources","full_name":"Demo Human Resources"}'::jsonb, now(), now()),
  ('00000000-0000-4000-8000-000000008103', 'authenticated', 'authenticated', 'demo.employee@example.test', crypt('DemoPass!2026', gen_salt('bf')), now(), '{"first_name":"Demo","last_name":"Employee","full_name":"Demo Employee"}'::jsonb, now(), now()),
  ('00000000-0000-4000-8000-000000008104', 'authenticated', 'authenticated', 'demo.applicant@example.test', crypt('DemoPass!2026', gen_salt('bf')), now(), '{"first_name":"Demo","last_name":"Applicant","full_name":"Demo Applicant"}'::jsonb, now(), now()),
  ('00000000-0000-4000-8000-000000008105', 'authenticated', 'authenticated', 'demo.management@example.test', crypt('DemoPass!2026', gen_salt('bf')), now(), '{"first_name":"Demo","last_name":"Management","full_name":"Demo Management"}'::jsonb, now(), now()),
  ('00000000-0000-4000-8000-000000008106', 'authenticated', 'authenticated', 'demo.unlinked-employee@example.test', crypt('DemoPass!2026', gen_salt('bf')), now(), '{"first_name":"Awaiting","last_name":"Record","full_name":"Awaiting Record"}'::jsonb, now(), now())
