  ...
  it("returns HR navigation scoped to HR personnel routes", () => {
    expect(getRoleConfig("hr_personnel")).toMatchObject({
      ...
      navigation: [
        ...
        { href: "/hr/employees", label: "Personnel records", group: "Workforce" },
        { href: "/hr/deployments", label: "Deployments", group: "Workforce" },
        { href: "/hr/promotions", label: "Promotions", group: "Workforce" },
