...
export default async function HrJobDetailPage({ params }: { params: Promise<{ jobId: string }> }) {
  ...
  return <main className="space-y-6"><div><p className="text-sm font-medium text-primary">Recruitment</p><h1 className="mt-1 text-3xl font-semibold tracking-tight">Edit job opening</h1></div><HrJobEditor jobId={parsed} /></main>;
}
