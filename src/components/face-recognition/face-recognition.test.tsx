...
describe("FaceAttendanceKiosk", () => {
  ...
  it.each([
    ...
    [{ status: "liveness", blink: { phase: "open", startedAt: 0, openFrames: 3, closedFrames: 0, reopenFrames: 0, baseline: 0.3, baselineTotal: 0.9, lastEar: 0.3 } }, /blink slowly once/i],
