...
export function ProfileChangeRequestForm() {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    const contactChanges = ([
      ["personalEmail", "personal_email"], ["phone", "phone"], ["address", "address"], ["emergencyContactName", "emergency_contact_name"], ["emergencyContactPhone", "emergency_contact_phone"],
  ...
  return <form className="space-y-6" noValidate onSubmit={onSubmit}>
    ...
    <fieldset className="space-y-4"><legend className="text-base font-semibold">Contact details</legend><div className="grid gap-4 sm:grid-cols-2">{([
      ["personalEmail", "Personal email", employeeData.personal_email, "email"], ["phone", "Phone", employeeData.phone ?? "", "tel"], ["address", "Address", employeeData.address ?? "", "text"], ["emergencyContactName", "Emergency contact name", employeeData.emergency_contact_name ?? "", "text"], ["emergencyContactPhone", "Emergency contact phone", employeeData.emergency_contact_phone ?? "", "tel"],
