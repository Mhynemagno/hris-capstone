...
type HrJobFormProps = {
  job?: JobOpening & { job_qualification_criteria?: JobQualificationCriterion[] };
};
...
export function HrJobForm({ job }: HrJobFormProps) {
  ...
  return <form className="max-w-3xl space-y-5" noValidate onSubmit={(event) => { event.preventDefault(); void saveAs("draft"); }}>
